    ...
    <div className="homepage-new">
      ...
      <HeroSection>
        ...
        <HeroSubtitle variant="h5">
          Unlock the full potential of your team with intuitive HR tools designed for modern businesses.
          From employee records to seamless payroll, all in one elegant platform.
        </HeroSubtitle>
        <CtaButton variant="contained" component={Link} to="/register">
          Get Started For Free
        </CtaButton>
        <Box sx={{ mt: 8, maxWidth: '90%', width: '100%', display: 'flex', justifyContent: 'center' }}>
          <img
      ...
      <FeaturesSection id="features">
        ...
        <Typography variant="h6" sx={{ color: '#666', mb: 6, animation: 'fadeIn 1.2s ease-out' }}>
          Everything you need to empower your workforce and streamline operations.
        </Typography>

        <FeaturesGrid>
          <FeatureCard>
            <FeatureIcon src="/images/icon-employee-records.png" alt="Employee Records" />
            <Typography variant="h5" sx={{ fontWeight: 600, mb: 1.5, color: '#333' }}>
              Centralized Employee Hub
            </Typography>
            <Typography variant="body1" sx={{ color: '#777' }}>
              Keep all employee information, documents, and performance reviews neatly organized and securely accessible.
            </Typography>
          </FeatureCard>
          <FeatureCard>
            <FeatureIcon src="/images/icon-leave-management.png" alt="Leave Management" />
            <Typography variant="h5" sx={{ fontWeight: 600, mb: 1.5, color: '#333' }}>
              Effortless Leave Management
            </Typography>
            <Typography variant="body1" sx={{ color: '#777' }}>
              Simplify time-off requests, approvals, and balance tracking with an intuitive self-service portal for staff.
            </Typography>
          </FeatureCard>
          <FeatureCard>
            <FeatureIcon src="/images/icon-payroll.png" alt="Payroll Tracking" />
            <Typography variant="h5" sx={{ fontWeight: 600, mb: 1.5, color: '#333' }}>
              Smart Payroll Processing
            </Typography>
            <Typography variant="body1" sx={{ color: '#777' }}>
              Automate payroll calculations, deductions, and bonuses, ensuring accuracy and compliance every pay cycle.
            </Typography>
          </FeatureCard>
        </FeaturesGrid>
      </FeaturesSection>
      ...
      {/* About Section */}
      <Box id="about" sx={{ padding: 8, textAlign: 'center', backgroundColor: '#eef2f5' }}>
        <Typography variant="h4" sx={{ fontWeight: 700, mb: 3, color: '#1a237e' }}>
          About SmartHR
        </Typography>
        <Typography variant="body1" sx={{ maxWidth: '800px', mx: 'auto', color: '#555', lineHeight: 1.8 }}>
          SmartHR.lk is committed to providing small and medium businesses in Sri Lanka with powerful, yet incredibly easy-to-use human resource management solutions. We believe that great HR shouldn't be complicated or expensive. Our platform is built to empower your business, allowing you to focus on growth while we handle the complexities of HR administration.
        </Typography>
      </Box>

      {/* Contact Section */}
      <Box id="contact" sx={{ padding: 8, textAlign: 'center', backgroundColor: '#f9f9f9' }}>
        <Typography variant="h4" sx={{ fontWeight: 700, mb: 3, color: '#1a237e' }}>
          Get in Touch
        </Typography>
        <Typography variant="body1" sx={{ maxWidth: '800px', mx: 'auto', color: '#555', lineHeight: 1.8 }}>
          Have questions or ready to see SmartHR in action? Our team is here to help. Contact us for a personalized demo or more information.
        </Typography>
